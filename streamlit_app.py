...
def home_page():
    ...
    st.markdown(
        ...
        2. Open **Price Model** for the current primary price-model workflow.
        3. Open **Price Model v2** for the cycle-by-cycle power-law comparison lab.
        4. Open **Calibrated Price Model** for calibration research.
        5. Open **BTC Financial Independence** to model your FI plan.
...
_NAV_PAGES = [
    ...
    st.Page(
        ...
        title="Price Model v2",
        url_path="price-model-v2",
    ),
    st.Page(
